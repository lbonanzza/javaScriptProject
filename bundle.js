...
/* harmony import */ var _PhonesCatalog_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16);
/* harmony import */ var _PhoneViewer_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
/* harmony import */ var _api_phone_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(18);
/* harmony import */ var _Basket_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(22);
/* harmony import */ var _Filters_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(23);
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(PhonesPage, [{
    ...
    value: function render() {
      ...
      this.initComponent(_Filters_js__WEBPACK_IMPORTED_MODULE_11__["default"], {
        query: this.state.query,
        sortField: this.state.sortField,
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Component, [{
    ...
    value: function initComponent(constructor, props) {
      ...
      var current = this.children[constructor.name];
...
function (_Component) {
  ...
  function PhoneViewer(element, props) {
    ...
    _this.render(); // Back button


    _this.on('click', 'back-button', _this.props.onBack); // Biggest current picture
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(PhoneViewer, [{
    ...
    value: function render() {
      ...
      this.element.innerHTML = "\n      <div>\n        <img class=\"phone\" src=\"".concat(currentPicture, "\">\n    \n        <button data-element=\"back-button\">Back</button>\n        <button data-element=\"add-button\">Add to basket</button>\n    \n        <h1>").concat(phone.name, "</h1>\n        <p>").concat(phone.description, "</p>\n    \n        <ul class=\"phone-thumbs\">\n        \n          ").concat(phone.images.map(function (imageUrl) {
        return "\n            <li>\n              <img src=\"".concat(imageUrl, "\" data-element=\"thumbnail\">\n            </li>\n          ");
      }).join(''), "\n        </ul>\n      </div>\n    ");
    }
  }]);
...
var API_URL = "https://mgrinko.github.io/js-20190426/api";
var getById =
/*#__PURE__*/
function () {
...
var getAll = function getAll(params) {
  return fetch("".concat(API_URL, "/phones.json?query=").concat(params.query, "&sortField=").concat(params.sortField)).then(function (response) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Basket, [{
    ...
    value: function render() {
      ...
      this.element.innerHTML = "\n      <section>\n        <h4>Shopping Cart</h4>\n        \n        ".concat(items.length > 0 ? "\n          <ul>\n          ".concat(items.map(function (item, index) {
        return "\n            <li>\n              ".concat(item, " \n              <button data-element=\"delete-button\" \n              data-item-index=\"").concat(index, "\">x</button>\n            </li>\n          ");
      }).join(''), "\n        </ul>") : "<p>no items yet</p>", "\n        \n      </section>\n    ");
    }
  }]);
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Filters, _Component);

  function Filters(element, props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Filters);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Filters).call(this, element, props));
